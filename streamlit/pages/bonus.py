...
if selected_league_id:
    ...
    if seasons:
        divisions = get_all_divisions_nb(league_id=selected_league_id, season=selected_season)
        ...
        if divisions:
            ...
            if st.button("Montre moi les bonus restants"):
                ...
                st.write(
                    f"Voici les bonus restants pour les joueurs de la ligue {selected_league_id}: ",
                    all_bonus_df,
                )
